...
import com.vinsguru.sec10.assignment.BookOrder;
import com.vinsguru.sec10.assignment.RevenueReport;
...
public class Lec02BufferAssignment {
    ...
    private static RevenueReport generateReport(List<BookOrder> orders){
        var revenue = orders.stream().collect(Collectors.groupingBy(
                BookOrder::genre,
